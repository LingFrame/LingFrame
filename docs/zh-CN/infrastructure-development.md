...
存储模块通过包装 JDBC 路径，让 SQL 操作在接近执行点的位置被观测和治理。
...
如果你要回到业务灵元一侧，请读 [业务灵元开发指南](ling-development.md)；  
如果你要看契约边界，请读 [Shared API 设计规范](shared-api-guidelines.md)。
