...
/**
 * Spring Boot 2.x 专用可重复读过滤器。
 * <p>
 * 基于 {@code javax.servlet} 实现：缓存请求体，使下游可多次读取。
 * 该类与 {@code lingframe-spring-boot3-starter} 中的 {@code JakartaRepeatableReadFilter}
 * 形成对等实现，差异仅在于 Servlet API 命名空间。
 */
public class JavaxRepeatableReadFilter implements Filter {

    private static final String FILTERED_ATTRIBUTE =
            JavaxRepeatableReadFilter.class.getName() + ".FILTERED";
