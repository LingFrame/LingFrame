...
public class LingFrameCoreConfiguration {
    ...
    public LingFrameConfig lingFrameConfig(LingFrameProperties properties,
        ...
        LingRuntimeConfig runtimeConfig = LingRuntimeConfig.builder()
                ...
                .resilienceEnabled(runtimeProperties.isResilienceEnabled())
                .circuitBreakerEnabled(runtimeProperties.isCircuitBreakerEnabled())
                .rateLimiterEnabled(runtimeProperties.isRateLimiterEnabled())
                .bulkheadEnabled(runtimeProperties.isBulkheadEnabled())
                .timeoutEnabled(runtimeProperties.isTimeoutEnabled())
