package com.lingframe.example.test.controller;
...
@Tag(name = "Test", description = "用户管理接口")
...
public class TestController {
    ...
    public TestDTO queryUser(String userId) {
    ...
    public void saveUser(@RequestBody TestDTO userDTO) {
